...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/al-soad-munna-225111239/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@alsoadmunna12",
    icon: Instagram,
    url: "https://www.instagram.com/alsoadmunna12/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@alsoadmunna",
    icon: Youtube,
    url: "https://www.youtube.com/@alsoadmunna/",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@kajialsoad",
    icon: Github,
    url: "https://github.com/kajialsoad",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@alsoadmunna0",
    color: "black",
  ...
  },
  {
    ...
    subText: "@alsoad.munna",
    icon: Facebook,
    url: "https://www.facebook.com/alsoad.munna/",
    color: "#1877F2",
    gradient: "from-[#1877F2] to-[#0066CC]"
  }
];
...
const SocialLinks = () => {
  ...
  const [instagram, youtube, github, tiktok, facebook] = otherLinks;
...
>
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent
        ...
        >
          <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500
                         bg-gradient-to-r ${facebook.gradient}`} />
